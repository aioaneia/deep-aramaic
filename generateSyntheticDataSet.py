...
LETTERS_VARIATION_PATH = "./images/letters-var/"
...
TEXTURE_LETTERS      = [
  '#3d3d3d', '#474545', '#464645', '#5f5d5c', '#535250', '#aea8a4'
]

TEXTURE_INSCRIPTIONS = [
  '#a09993', '#a3a1a1', '#a9753f', 
  '#b2aca9', '#b39572',
  '#c5c3c3',
  '#d1a170', '#dfd9d6', '#d4d4ce',
  '#525151', '#544e47', '#504842', '#5e5551',
  '#6e6e69', '#6e6c68', '#625f5d',
  '#726d6b', '#7f766f',  '#73716d', '#8a8881',
  '#998e84', '#989794', '#947c6a'
]

IMG_WIDTH  = 350
IMG_HEIGHT = 350

NR_OF_TRAINING_IMAGES    = 4500
NR_OF_VALIDATION_IMAGES  = 850
NR_OF_TESTING_IMAGES     = 800
...
def generate_training_dataset(nrOfImages, nrOfLetters):
...
def generate_validation_dataset(nrOfImages, nrOfLetters):
    bgColors, fgColors = prepareColors(TEXTURE_LETTERS, TEXTURE_INSCRIPTIONS)
...
def generate_testing_dataset(nrOfImages, nrOfLetters):
...
def main():
    ...
    generate_training_dataset(NR_OF_TRAINING_IMAGES, 4)

    generate_validation_dataset(NR_OF_VALIDATION_IMAGES, 4)

    generate_testing_dataset(NR_OF_TESTING_IMAGES, 4)
